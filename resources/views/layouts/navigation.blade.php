<nav x-data="{ open: false }" class="bg-cyan-500 border-b border-cyan-600 shadow-md">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:ms-10 sm:flex">
                    @if (Auth::user()->role === 'super_admin')
                        ...
                        <a href="{{ route('superadmin.anggota.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg ...">
                             <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            Data Nasabah
                        </a>
                    ...
                    @elseif (Auth::user()->role === 'karyawan')
                        ...
                        <a href="{{ route('anggota.riwayat.search.form') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg ...">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01V4m0 2.01V4M12 14c-1.657 0-3-.895-3-2s1.343-2 3-2 3-.895 3-2-1.343-2-3-2m0 8c1.11 0 2.08-.402 2.599-1M12 14v1m0-1v-.01m0-2.01V12m0-2.01V10m0 2.01V10"></path></svg>
                            Cek Riwayat
                        </a>
                        ...
                        <a href="{{ route('karyawan.gaji.saya') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg transition duration-150 ease-in-out">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01V4m0 2.01V4M12 14c-1.657 0-3-.895-3-2s1.343-2 3-2 3-.895 3-2-1.343-2-3-2m0 8c1.11 0 2.08-.402 2.599-1M12 14v1m0-1v-.01m0-2.01V12m0-2.01V10m0 2.01V10"></path></svg>
                            Gaji Saya
                        </a>
                    ...
                    @elseif (Auth::user()->role === 'admin')
                        ...
                        <a href="{{ route('admin.gaji.saya') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg transition duration-150 ease-in-out">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 6v-1m0-1V4m0 2.01V4m0 2.01V4M12 14c-1.657 0-3-.895-3-2s1.343-2 3-2 3-.895 3-2-1.343-2-3-2m0 8c1.11 0 2.08-.402 2.599-1M12 14v1m0-1v-.01m0-2.01V12m0-2.01V10m0 2.01V10"></path></svg>
        Gaji Saya
    </a>
    ...
    <a href="{{ route('sekertaris.pinjaman.rekap') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg transition duration-150 ease-in-out">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m14-2v-2a4 4 0 00-4-4h-2m14-3a4 4 0 00-4-4h-2m-4-4a4 4 0 00-4 4v2"></path></svg>
        Rekap Pinjaman
    </a>
    <a href="{{ route('sekertaris.gaji.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-5 text-white hover:bg-cyan-600 rounded-lg transition duration-150 ease-in-out">
        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m14-2v-2a4 4 0 00-4-4h-2m14-3a4 4 0 00-4-4h-2m-4-4a4 4 0 00-4 4v2"></path></svg>
        Kelola Gaji
    </a>
                    @endif
