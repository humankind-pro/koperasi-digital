            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'super_admin')
                        ...
                        <x-nav-link :href="route('karyawans.index')" :active="request()->routeIs('karyawans.*')">
                            {{ __('Data Karyawan') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === 'super_admin')
                ...
                <x-responsive-nav-link :href="route('karyawans.index')" :active="request()->routeIs('karyawans.*')">
                    {{ __('Data Karyawan') }}
                </x-responsive-nav-link>
