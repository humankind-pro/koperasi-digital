                        ...
                        @forelse ($pengajuanAnggota as $anggota)
                            <div class="flex items-center py-3 border-b">
                                ...
                                <div class="w-1/3 text-right space-x-2">
                                    ...
                                    {{-- PERBAIKAN DI SINI --}}
                                    {{-- =============================================================== --}}
                                    <form action="{{ route('admin.validasi.tolak', $anggota->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('admin.validasi.setujui', $anggota->id) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('PATCH')
