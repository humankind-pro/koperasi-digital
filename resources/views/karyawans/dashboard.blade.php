    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 px-4 sm:px-0">
                ...
                <a href="{{ route('karyawan.pinjaman.aktif') }}" class="group block bg-green-500 hover:bg-green-600 transition duration-300 p-6 rounded-xl shadow-md text-white relative overflow-hidden">
                ...
                <a href="{{ route('pinjaman.create') }}" class="group block bg-blue-500 hover:bg-blue-600 transition duration-300 p-6 rounded-xl shadow-md text-white relative overflow-hidden">
                    <div class="relative z-10">
                        <div class="mb-4 opacity-90">
