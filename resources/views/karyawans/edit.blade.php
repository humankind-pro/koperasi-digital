                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('karyawans.update', $karyawan->id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $karyawan->name)" required autofocus />
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('karyawans.index') }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                Batal
                            </a>
                            <x-primary-button>
                                {{ __('Simpan Perubahan') }}
