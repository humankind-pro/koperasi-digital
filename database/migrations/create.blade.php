                ...
                <div class="bg-gradient-to-r from-cyan-600 via-blue-600 to-blue-700 px-8 py-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-cyan-100 text-lg">Upload KTP → data otomatis terbaca dalam 3 detik!</p>
                        </div>
                        <div class="hidden md:block">
                            <div class="bg-white/20 backdrop-blur-sm rounded-2xl px-6 py-4">
                                <p class="text-white text-sm font-medium">Akurasi OCR</p>
                                <p class="text-white text-3xl font-bold">98%</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="ocr-loading" class="hidden text-center py-12">
                            <div class="inline-flex flex-col items-center space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-2">Teknologi AI</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 rounded-3xl p-6 border-2 border-cyan-200 shadow-xl">
                                <div class="flex items-center justify-between mb-5">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <h5 class="text-xl font-bold text-cyan-800">Data KTP Terdeteksi</h5>
                                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function startOCRProcess(file) {
                ...
                .catch(err => {
                    ...
                    ocrLoading.classList.add('hidden');
                    // Show error and enable manual mode
                    showNotification('⚠️ Gagal membaca KTP. Silakan input manual.', 'error');
                    ocrResult.classList.remove('hidden');
